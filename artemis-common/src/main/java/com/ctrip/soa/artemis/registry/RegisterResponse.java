 ...
 */
public class RegisterResponse implements HasResponseStatus, HasFailedInstances {
    ...
    public RegisterResponse(List<FailedInstance> failedInstances, ResponseStatus responseStatus) {
